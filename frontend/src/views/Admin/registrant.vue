<template>
    <div class="absolute top-32 w-full flex justify-center" style="height: 30rem;">
        <div class="overflow-auto w-5/6 h-full no-scrollbar mt-5">
            <table class="table-fixed border-collapse border border-primary-200 w-full">
                ...
                <tbody>
                    <tr class="text-center even:bg-sky-100 odd:bg-sky-200" v-for="i in 9" :key="i">
                        <td class="text-primary-900">Widean@wmail.com</td>
                        <td class="py-5">
                            <span class="bg-primary-700 ring-2 ring-inset ring-primary-400 rounded-full h-auto w-auto text-base px-10 py-2 mr-1" > 
                                Available
                            </span>
                        </td>
                        <td>
                    ...
                    <tr class="text-center even:bg-sky-100">
                        <td class="text-primary-900">Widean@wmail.com</td>
                        <td class="py-5">
                            <span class="bg-primary-600 ring-2 ring-inset ring-primary-400 rounded-full h-auto w-64 text-base px-12 py-2 mr-1" > 
                                Deleted
                            </span>
                        </td>
                        <td>
