        ...
        <div class="w-5/6 h-full">
            ...
            <div class="overflow-auto w-full h-auto max-h-[30rem] no-scrollbar mt-5 rounded-lg shadow-xl" v-if="this.sectionList!=null">
                <table class="table-fixed w-full font-semibold text-xl">
                    ...
                    <tbody>
                        <tr class="text-center odd:bg-foreground-4-50 even:bg-foreground-4-10 text-xl" v-for="i in this.sectionList" :key="i">
            ...
            <div v-show="this.questionList!=null">
                ...
                <div class="overflow-auto w-full h-96 no-scrollbar mt-3">
                    <table class="table-fixed w-full font-semibold text-xl">
                        ...
                        <tbody>
                            <tr class="text-center odd:bg-foreground-4-50 even:bg-foreground-4-10 text-xl" v-for="(i,idx) in this.questionList" :key="idx">
                                <td>{{idx+1}}</td>
