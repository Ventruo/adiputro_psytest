...
async function calculate_nine_tests(test_type, testres, res) {
...
async function process_nine(excel_path, sheet, correct_data, res, testres) {
...
module.exports = { calculate_nine_tests };
